...
- You are confirming 3 non-negotiable conditions:
  1) 18+,
  2) tablet or laptop + internet (smartphones/phones are NOT acceptable),
...
Rules:
- If any indication of under-18, no tablet/laptop+internet (or only phone/smartphone), or not ok with unpaid volunteering -> ELIGIBLE_NO.
